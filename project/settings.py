...
SECRET_KEY = 'django-insecure-e^-yeb1=$959ops@_8@=w50akf8-$cktg%oqt8q=d=hlmt&ga*'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'critical_file': {
            'level': 'CRITICAL',
            'class': 'logging.FileHandler',
            'filename': 'app/logs/critical.log',
            'formatter': 'verbose',
        },
        'warning_file': {
            'level': 'WARNING',
    ...
    'loggers': {
        'django': {
            'handlers': ['console', 'error_file','info_file','critical_file','warning_file','debug_file'],
            'level': 'DEBUG',
            'propagate': True,
        },
    },
